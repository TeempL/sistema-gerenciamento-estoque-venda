...
import com.techsolutions.gestaovenda.modelo.entidades.Categoria;
import com.techsolutions.gestaovenda.modelo.exception.NegocioException;
import com.techsolutions.gestaovenda.modelo.util.CategoriaTableModel;
...
public class CategoriaController implements ActionListener, MouseListener{
    ...
    private void validacaoDoCampo(String campo) {
        if(campo.isEmpty()) {
            String mensagem = "Deve preencher o campo nome";
            mensagemNaTela(mensagem, Color.RED);
    ...
    private void apagar() {
        if (categoria != null) {
            ...
            mensagemNaTela("Deve selecionar um categoria na tabela", Color.RED);
        }
    }
