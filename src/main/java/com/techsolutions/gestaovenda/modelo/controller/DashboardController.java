...
public final class DashboardController implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        switch(accao) {
            ...
            case "quem somos": panelSobre(); break;
    ...
    private void sair() {
        int confirma = JOptionPane.showConfirmDialog(null, "Certeza que desejas sair?","Sair do login", JOptionPane.YES_NO_OPTION);
    ...
    private void panelSobre() {
        painelComponentes(this.dashboard.getPanelSobre());
    }
